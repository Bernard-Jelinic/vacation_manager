...
@section('employees.edit')
    ...
    <div class="container-fluid col-lg-5">
        <form action="{{ route('employees.update',$employee->id) }}" method="POST" enctype="multipart/form-data"><br>
            ...
            @if ($employee)
                <div class="form-group">
                    ...
                    <input value="{{$employee->name}}" id="name" type="text" class="form-control @error('name') error-border @enderror" placeholder="Employee name" name="name" autofocus>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input value="{{$employee->last_name}}" id="last_name" type="text" class="form-control @error('last_name') error-border @enderror" placeholder="Employee last name" name="last_name" required autofocus>
                @error('last_name')
                    <div class="error-text">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('email') error-border @enderror" type="text" placeholder="Enter email" name="email" value="{{$employee->email}}"/>
                @error('email')
                    <div class="error-text">
                        {{ $message }}
                    </div>
